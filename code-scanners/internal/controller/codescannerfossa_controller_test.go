...
func TestCodeScannerFossaReconciler_Reconcile(t *testing.T) {
	const resourceName = "test-fossa"
	...
	resource := &maintainerdcncfiov1alpha1.CodeScannerFossa{
	...
	// Test reconciliation
	controllerReconciler := &CodeScannerFossaReconciler{
		Client: k8sClient,
